// ===============================================
//   DATABASE KONTEN WEBSITE SANDEX
//   Edit file ini untuk menambah atau mengubah postingan.
// ===============================================

// --- Data untuk Postingan di Halaman Utama ---
const postsData = [
{
id: 1,
...
videoLink1: 'https://link-video-pertama-anda.com', // \<-- DATA BARU
videoLink2: 'https://link-video-kedua-anda.com'   // \<-- DATA BARU
},
{
id: 2,
...
videoLink1: '\#', // Ganti dengan link Anda
videoLink2: '\#'  // Ganti dengan link Anda
},
{
id: 3,
...
linkUrl: 'youtube.com' // Ganti '\#' dengan link tujuan iklan Anda
};
